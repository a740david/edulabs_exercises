from lesson11.lesson_11.table_system import TableReservationSystem
from lesson11.lesson_11.table_excption import *
...
if __name__ == '__main__':
    ...
    try:
      print(japanika.release(table_5))
    except Occupied_seats as e:
        print(e)
